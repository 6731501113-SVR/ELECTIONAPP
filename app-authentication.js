module.exports = function (app, db, argon2) {
    ...
    app.post('/admin/login', async (req, res) => {
        try {
            ...
            // 1. ค้นหา User จาก username เท่านั้น
            ...
            if (results.length > 0) {
                ...
                // 2. ใช้ argon2.verify(hash ใน DB, password ที่ส่งมา)
                // ฟังก์ชันนี้จะคืนค่าเป็น true หากรหัสผ่านถูกต้อง
                if (await argon2.verify(admin.password, password)) {

                    // 3. จัดการ Session เมื่อรหัสผ่านถูกต้อง
